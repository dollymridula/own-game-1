...
function preload(){
  ...
  ironMan_running = loadAnimation("ironMan");
  ironMan_collided = loadAnimation("ironMan_collided.png");
  
  roadImage = loadImage("road2.png");
  
  cloudImage = loadImage("cloud.png");
  
  buildin1 = loadImage("buildin1.png");
  buildin2 = loadImage("buildin2.png");
  buildin3 = loadImage("buildin3.png");
  building4 = loadImage("buildin4.png");
 ...
 function setup(){
  ...
  road.addImage("ground",roadImage);
  road.x = road.width /2;
